...
async function BlackFridayBanner() {
    const sale = await getActiveSaleByCouponCode("BLACKFRIDAY");
    ...
    return (
        <div
            className="bg-gradient-to-r from-red-600 to-black text-white px-6 py-10 mx-4 mt-2 rounded-lg shadow-lg">
